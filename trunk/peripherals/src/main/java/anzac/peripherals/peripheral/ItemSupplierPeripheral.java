...
@Peripheral(type = "ItemSupplier", events = { PeripheralEvent.item_route })
public class ItemSupplierPeripheral extends BaseRouterPeripheral {

	public ItemSupplierPeripheral(final ItemSupplierTileEntity entity) {
		super(entity);
	}

	@Override
	protected ItemSupplierTileEntity getEntity() {
		return (ItemSupplierTileEntity) super.getEntity();
	}

	@Override
	protected List<String> methodNames() {
		return ClassUtils.getMethodNames(ItemSupplierPeripheral.class);
	}
