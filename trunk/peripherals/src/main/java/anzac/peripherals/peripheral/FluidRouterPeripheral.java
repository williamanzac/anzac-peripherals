...
public class FluidRouterPeripheral extends BaseRouterPeripheral {

	public FluidRouterPeripheral(FluidRouterTileEntity entity) {
		super(entity);
	}

	@Override
	protected List<String> methodNames() {
		return ClassUtils.getMethodNames(FluidRouterPeripheral.class);
	}

	@Override
	protected FluidRouterTileEntity getEntity() {
		return (FluidRouterTileEntity) super.getEntity();
	}
